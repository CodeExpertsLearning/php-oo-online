...
namespace Sincco\Excell\Chart\Renderer;

require_once \Sincco\Excell\Settings::getChartRendererPath() . '/jpgraph.php';
...
class JpGraph
{
    ...
    private function formatDataSetLabels($groupID, $datasetLabels, $labelCount, $rotation = '')
    {
        ...
        foreach ($datasetLabels as $i => $datasetLabel) {
            if (is_array($datasetLabel)) {
                ...
                if (!is_null($datasetLabelFormatCode)) {
                    $datasetLabels[$i] = \Sincco\Excell\Style\NumberFormat::toFormattedString($datasetLabel, $datasetLabelFormatCode);
                }
            }
            ++$testCurrentIndex;
        }
    ...
    {
        require_once \Sincco\Excell\Settings::getChartRendererPath() . 'jpgraph_line.php';
    ...
    {
        require_once \Sincco\Excell\Settings::getChartRendererPath() . 'jpgraph_bar.php';
    ...
    {
        require_once \Sincco\Excell\Settings::getChartRendererPath() . 'jpgraph_scatter.php';
        require_once \Sincco\Excell\Settings::getChartRendererPath() . 'jpgraph_regstat.php';
        require_once \Sincco\Excell\Settings::getChartRendererPath() . 'jpgraph_line.php';
    ...
    {
        require_once \Sincco\Excell\Settings::getChartRendererPath() . 'jpgraph_pie.php';
        if ($dimensions == '3d') {
            require_once \Sincco\Excell\Settings::getChartRendererPath() . 'jpgraph_pie3d.php';
        }
    ...
    {
        require_once \Sincco\Excell\Settings::getChartRendererPath() . 'jpgraph_radar.php';
    ...
    {
        require_once \Sincco\Excell\Settings::getChartRendererPath() . 'jpgraph_stock.php';
    ...
    {
        require_once \Sincco\Excell\Settings::getChartRendererPath() . 'jpgraph_contour.php';
     ...
     */
    public function __construct(\Sincco\Excell\Chart $chart)
    {
        $this->graph = null;
        $this->chart = $chart;
    }
