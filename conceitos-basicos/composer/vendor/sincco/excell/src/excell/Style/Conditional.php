 ...
 */
class Conditional implements \Sincco\Excell\IComparable
{
    /* Condition types */
    ...
    public function __construct()
    {
        ...
        $this->text = null;
        $this->condition = [];
        $this->style = new \Sincco\Excell\Style(false, true);
    }
     ...
     * Set Style
     *
     * @param   \Sincco\Excell\Style $pValue
     * @throws  \Sincco\Excell\Exception
     * @return  Conditional
     */
    public function setStyle(\Sincco\Excell\Style $pValue = null)
    {
        $this->style = $pValue;
