 ...
 */
class Alignment extends Supervisor implements \Sincco\Excell\IComparable
{
     ...
     *        array(
     *            'horizontal' => \Sincco\Excell\Style\Alignment::HORIZONTAL_CENTER,
     *            'vertical'   => \Sincco\Excell\Style\Alignment::VERTICAL_CENTER,
     *            'rotation'   => 0,
     *            'wrap'            => TRUE
     *        )
     * );
    ...
    {
        // Excel2007 value 255 => Excell value -165
        if ($pValue == 255) {
            $pValue = -165;
        }
        ...
        if (($pValue >= -90 && $pValue <= 90) || $pValue == -165) {
            ...
            throw new \Sincco\Excell\Exception('Text rotation should be a value between -90 and 90.');
        }
