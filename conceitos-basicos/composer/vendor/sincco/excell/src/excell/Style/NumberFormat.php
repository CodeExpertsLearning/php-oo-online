 ...
 */
class NumberFormat extends Supervisor implements \Sincco\Excell\IComparable
{
    /* Pre-defined formats */
     ...
     *        array(
     *            'code' => \Sincco\Excell\Style\NumberFormat::FORMAT_CURRENCY_EUR_SIMPLE
     *        )
     * );
     * </code>
     *
    ...
    public function applyFromArray($pStyles = null)
    {
        if (is_array($pStyles)) {
            ...
            throw new \Sincco\Excell\Exception('Invalid style array passed.');
        }
    ...
    private static function formatAsDate(&$value, &$format)
    {
        ...
        $dateObj = \Sincco\Excell\Shared\Date::excelToDateTimeObject($value);
    ...
    private static function formatAsFraction(&$value, &$format)
    {
        ...
        $GCD = \Sincco\Excell\Calculation\MathTrig::GCD($decimalPart, $decimalDivisor);
                    ...
                    if (preg_match($number_regex, $m, $matches)) {
                        ...
                        if ($useThousands) {
                            $value = number_format(
                                $value,
                                strlen($right),
                                \Sincco\Excell\Shared\StringHelper::getDecimalSeparator(),
