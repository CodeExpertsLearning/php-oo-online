 ...
 */
class Border extends Supervisor implements \Sincco\Excell\IComparable
{
    /* Border style */
    ...
    public function getSharedComponent()
    {
        switch ($this->parentPropertyName) {
            ...
            case 'outline':
            case 'vertical':
                throw new \Sincco\Excell\Exception('Cannot get shared component for a pseudo-border.');
                break;
            case 'bottom':
     ...
     *        array(
     *            'style' => \Sincco\Excell\Style\Border::BORDER_DASHDOT,
     *            'color' => array(
     *                'rgb' => '808080'
     *            )
     *        )
