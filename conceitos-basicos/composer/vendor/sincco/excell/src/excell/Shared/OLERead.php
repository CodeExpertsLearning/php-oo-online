...
class OLERead
{
    ...
    public function read($sFileName)
    {
        ...
        if (!is_readable($sFileName)) {
            throw new \Sincco\Excell\Reader\Exception('Could not open ' . $sFileName . ' for reading! File does not exist, or it is not readable.');
        }
        ...
        if ($this->data != self::IDENTIFIER_OLE) {
            throw new \Sincco\Excell\Reader\Exception('The filename ' . $sFileName . ' is not recognised as an OLE file');
        }
    ...
    private static function getInt4d($data, $pos)
    {
        if (trim($data) == '') {
            // No data provided
            throw new \Sincco\Excell\Reader\Exception('Parameter data is empty.');
        } elseif ($pos < 0) {
            // Invalid position
            throw new \Sincco\Excell\Reader\Exception('Parameter pos=' . $pos . ' is invalid.');
        }
