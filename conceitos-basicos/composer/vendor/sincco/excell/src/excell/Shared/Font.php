...
class Font
{
     ...
     *
     * @param     \Sincco\Excell\Style\Font            $font            Font object
     * @param     \Sincco\Excell\RichText|string    $cellText        Text to calculate width
     * @param     int                        $rotation        Rotation angle
     * @param     \Sincco\Excell\Style\Font|null    $defaultFont    Font object
     * @return     int        Column width
     */
    public static function calculateColumnWidth(\Sincco\Excell\Style\Font $font, $cellText = '', $rotation = 0, \Sincco\Excell\Style\Font $defaultFont = null)
    {
        // If it is rich text, use plain text
        if ($cellText instanceof \Sincco\Excell\RichText) {
     ...
     *
     * @param string $text
     * @param \Sincco\Excell\Style\Font
     * @param int $rotation
     * @throws \Sincco\Excell\Exception
     * @return int
     */
    public static function getTextWidthPixelsExact($text, \Sincco\Excell\Style\Font $font, $rotation = 0)
    {
        if (!function_exists('imagettfbbox')) {
            throw new \Sincco\Excell\Exception('GD library needs to be enabled');
        }
     ...
     */
    public static function getTextWidthPixelsApprox($columnText, \Sincco\Excell\Style\Font $font = null, $rotation = 0)
    {
    ...
    public static function getTrueTypeFontFileFromFont($font)
    {
        if (!file_exists(self::$trueTypeFontPath) || !is_dir(self::$trueTypeFontPath)) {
            throw new \Sincco\Excell\Exception('Valid directory to TrueType Font files not specified');
        }
        ...
        switch ($name) {
            ...
            case 'Verdana':
                ...
                break;
            default:
                throw new \Sincco\Excell\Exception('Unknown font name "' . $name . '". Cannot map to TrueType font file');
                break;
        }
        ...
        if (!file_exists($fontFile)) {
            throw new \Sincco\Excell\Exception('TrueType Font file not found');
        }
     ...
     *
     * @param \Sincco\Excell\Style\Font $font The workbooks default font
     * @param bool $pPixels true = return column width in pixels, false = return in OOXML units
     * @return mixed Column width
     */
    public static function getDefaultColumnWidthByFont(\Sincco\Excell\Style\Font $font, $pPixels = false)
    {
     ...
     */
    public static function getDefaultRowHeightByFont(\Sincco\Excell\Style\Font $font)
    {
        switch ($font->getName()) {
            case 'Arial':
                switch ($font->getSize()) {
