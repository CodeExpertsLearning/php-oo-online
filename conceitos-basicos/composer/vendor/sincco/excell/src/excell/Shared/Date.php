...
namespace Sincco\Excell\Shared;
...
class Date
{
     ...
     *
     * @param   \Sincco\Excell\Cell    $pCell
     * @return  bool
     */
    public static function isDateTime(\Sincco\Excell\Cell $pCell)
    {
     ...
     *
     * @param   \Sincco\Excell\Style\NumberFormat    $pFormat
     * @return  bool
     */
    public static function isDateTimeFormat(\Sincco\Excell\Style\NumberFormat $pFormat)
    {
    ...
    {
        if (strtolower($pFormatCode) === strtolower(\Sincco\Excell\Style\NumberFormat::FORMAT_GENERAL)) {
        ...
        switch ($pFormatCode) {
            ...
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_YYYYMMDD:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_YYYYMMDD2:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_DDMMYYYY:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_DMYSLASH:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_DMYMINUS:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_DMMINUS:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_MYMINUS:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_DATETIME:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_TIME1:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_TIME2:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_TIME3:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_TIME4:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_TIME5:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_TIME6:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_TIME7:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_TIME8:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_YYYYMMDDSLASH:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_XLSX14:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_XLSX15:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_XLSX16:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_XLSX17:
            case \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_XLSX22:
                return true;
        }
    ...
    public static function stringToExcel($dateValue = '')
    {
        ...
        $dateValueNew = \Sincco\Excell\Calculation\DateTime::DATEVALUE($dateValue);

        if ($dateValueNew === \Sincco\Excell\Calculation\Functions::VALUE()) {
            return false;
        }

        if (strpos($dateValue, ':') !== false) {
            $timeValue = \Sincco\Excell\Calculation\DateTime::TIMEVALUE($dateValue);
            if ($timeValue === \Sincco\Excell\Calculation\Functions::VALUE()) {
                return false;
            }
