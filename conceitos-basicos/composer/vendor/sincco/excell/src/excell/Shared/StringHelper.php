...
/**    Regular Expressions        */
    ...
    public static function convertToNumberIfFraction(&$operand)
    {
        if (preg_match('/^' . self::STRING_REGEXP_FRACTION . '$/i', $operand, $match)) {
            ...
            $operand = \Sincco\Excell\Calculation::getInstance()->_calculateFormulaValue($fractionFormula);
    ...
    /**
     * Set the decimal separator. Only used by \Sincco\Excell\Style\NumberFormat::toFormattedString()
     * to format output by \Sincco\Excell\Writer\HTML and \Sincco\Excell\Writer\PDF
     *
    ...
    /**
     * Set the thousands separator. Only used by \Sincco\Excell\Style\NumberFormat::toFormattedString()
     * to format output by \Sincco\Excell\Writer\HTML and \Sincco\Excell\Writer\PDF
     *
    ...
    /**
     * Set the currency code. Only used by \Sincco\Excell\Style\NumberFormat::toFormattedString()
     *        to format output by \Sincco\Excell\Writer\HTML and \Sincco\Excell\Writer\PDF
     *
