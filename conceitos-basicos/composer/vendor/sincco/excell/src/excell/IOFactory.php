...
class IOFactory
{
    ...
    private static $searchLocations = [
        ['type' => 'IWriter', 'path' => 'Excell/Writer/{0}.php', 'class' => '\\Sincco\\Excell\\Writer\\{0}'],
        ['type' => 'IReader', 'path' => 'Excell/Reader/{0}.php', 'class' => '\\Sincco\\Excell\\Reader\\{0}'],
    ];
     ...
     * @param    string $location    Example: Excell/Writer/{0}.php
