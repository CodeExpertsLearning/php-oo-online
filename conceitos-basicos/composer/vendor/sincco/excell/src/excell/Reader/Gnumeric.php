...
class Gnumeric extends BaseReader implements IReader
{
    ...
    public function listWorksheetNames($pFilename)
    {
        ...
        $xml = new XMLReader();
        $xml->xml($this->securityScanFile('compress.zlib://' . realpath($pFilename)), null, \Sincco\Excell\Settings::getLibXmlLoaderOptions());
    ...
    public function loadIntoExisting($pFilename, Spreadsheet $spreadsheet)
    {
        ...
        $xml = simplexml_load_string($this->securityScan($gFileData), 'SimpleXMLElement', \Sincco\Excell\Settings::getLibXmlLoaderOptions());
        ...
        foreach ($gnmXML->Sheets->Sheet as $sheet) {
            ...
            foreach ($sheet->Cells->Cell as $cell) {
                ...
                $column = \Sincco\Excell\Cell::stringFromColumnIndex($column);
            ...
            foreach ($sheet->Styles->StyleRegion as $styleRegion) {
                ...
                if (($styleAttributes['startRow'] <= $maxRow) &&
                    ...
                    $startColumn = \Sincco\Excell\Cell::stringFromColumnIndex((int) $styleAttributes['startCol']);
                    $startRow = $styleAttributes['startRow'] + 1;

                    $endColumn = ($styleAttributes['endCol'] > $maxCol) ? $maxCol : (int) $styleAttributes['endCol'];
                    $endColumn = \Sincco\Excell\Cell::stringFromColumnIndex($endColumn);
                    ...
                    if ((!$this->readDataOnly) ||
                        (\Sincco\Excell\Shared\Date::isDateTimeFormatCode((string) $styleAttributes['Format']))) {
                        $styleArray = [];
                        ...
                        if (!$this->readDataOnly) {
                            switch ($styleAttributes['HAlign']) {
                                case '1':
                                    $styleArray['alignment']['horizontal'] = \Sincco\Excell\Style\Alignment::HORIZONTAL_GENERAL;
                                    break;
                                case '2':
                                    $styleArray['alignment']['horizontal'] = \Sincco\Excell\Style\Alignment::HORIZONTAL_LEFT;
                                    break;
                                case '4':
                                    $styleArray['alignment']['horizontal'] = \Sincco\Excell\Style\Alignment::HORIZONTAL_RIGHT;
                                    break;
                                case '8':
                                    $styleArray['alignment']['horizontal'] = \Sincco\Excell\Style\Alignment::HORIZONTAL_CENTER;
                                    break;
                                case '16':
                                case '64':
                                    $styleArray['alignment']['horizontal'] = \Sincco\Excell\Style\Alignment::HORIZONTAL_CENTER_CONTINUOUS;
                                    break;
                                case '32':
                                    $styleArray['alignment']['horizontal'] = \Sincco\Excell\Style\Alignment::HORIZONTAL_JUSTIFY;
                                    break;
                            }

                            switch ($styleAttributes['VAlign']) {
                                case '1':
                                    $styleArray['alignment']['vertical'] = \Sincco\Excell\Style\Alignment::VERTICAL_TOP;
                                    break;
                                case '2':
                                    $styleArray['alignment']['vertical'] = \Sincco\Excell\Style\Alignment::VERTICAL_BOTTOM;
                                    break;
                                case '4':
                                    $styleArray['alignment']['vertical'] = \Sincco\Excell\Style\Alignment::VERTICAL_CENTER;
                                    break;
                                case '8':
                                    $styleArray['alignment']['vertical'] = \Sincco\Excell\Style\Alignment::VERTICAL_JUSTIFY;
                                    break;
                            }
                            ...
                            if (($RGB != '000000') || ($shade != '0')) {
                                ...
                                switch ($shade) {
                                    case '1':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_SOLID;
                                        break;
                                    case '2':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_GRADIENT_LINEAR;
                                        break;
                                    case '3':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_GRADIENT_PATH;
                                        break;
                                    case '4':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_PATTERN_DARKDOWN;
                                        break;
                                    case '5':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_PATTERN_DARKGRAY;
                                        break;
                                    case '6':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_PATTERN_DARKGRID;
                                        break;
                                    case '7':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_PATTERN_DARKHORIZONTAL;
                                        break;
                                    case '8':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_PATTERN_DARKTRELLIS;
                                        break;
                                    case '9':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_PATTERN_DARKUP;
                                        break;
                                    case '10':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_PATTERN_DARKVERTICAL;
                                        break;
                                    case '11':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_PATTERN_GRAY0625;
                                        break;
                                    case '12':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_PATTERN_GRAY125;
                                        break;
                                    case '13':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_PATTERN_LIGHTDOWN;
                                        break;
                                    case '14':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_PATTERN_LIGHTGRAY;
                                        break;
                                    case '15':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_PATTERN_LIGHTGRID;
                                        break;
                                    case '16':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_PATTERN_LIGHTHORIZONTAL;
                                        break;
                                    case '17':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_PATTERN_LIGHTTRELLIS;
                                        break;
                                    case '18':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_PATTERN_LIGHTUP;
                                        break;
                                    case '19':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_PATTERN_LIGHTVERTICAL;
                                        break;
                                    case '20':
                                        $styleArray['fill']['type'] = \Sincco\Excell\Style\Fill::FILL_PATTERN_MEDIUMGRAY;
                                        break;
                                }
                            }
                            ...
                            switch ($fontAttributes['Underline']) {
                                case '1':
                                    $styleArray['font']['underline'] = \Sincco\Excell\Style\Font::UNDERLINE_SINGLE;
                                    break;
                                case '2':
                                    $styleArray['font']['underline'] = \Sincco\Excell\Style\Font::UNDERLINE_DOUBLE;
                                    break;
                                case '3':
                                    $styleArray['font']['underline'] = \Sincco\Excell\Style\Font::UNDERLINE_SINGLEACCOUNTING;
                                    break;
                                case '4':
                                    $styleArray['font']['underline'] = \Sincco\Excell\Style\Font::UNDERLINE_DOUBLEACCOUNTING;
                                    break;
                                default:
                                    $styleArray['font']['underline'] = \Sincco\Excell\Style\Font::UNDERLINE_NONE;
                                    break;
                            }
                            ...
                            if (isset($styleRegion->Style->StyleBorder)) {
                                ...
                                if ((isset($styleRegion->Style->StyleBorder->Diagonal)) && (isset($styleRegion->Style->StyleBorder->{'Rev-Diagonal'}))) {
                                    ...
                                    $styleArray['borders']['diagonaldirection'] = \Sincco\Excell\Style\Borders::DIAGONAL_BOTH;
                                } elseif (isset($styleRegion->Style->StyleBorder->Diagonal)) {
                                    $styleArray['borders']['diagonal'] = self::parseBorderAttributes($styleRegion->Style->StyleBorder->Diagonal->attributes());
                                    $styleArray['borders']['diagonaldirection'] = \Sincco\Excell\Style\Borders::DIAGONAL_UP;
                                    ...
                                    $styleArray['borders']['diagonaldirection'] = \Sincco\Excell\Style\Borders::DIAGONAL_DOWN;
                                }
                            }
            ...
            if ((!$this->readDataOnly) && (isset($sheet->Cols))) {
                ...
                foreach ($sheet->Cols->ColInfo as $columnOverride) {
                    ...
                    while ($c < $column) {
                        $spreadsheet->getActiveSheet()->getColumnDimension(\Sincco\Excell\Cell::stringFromColumnIndex($c))->setWidth($defaultWidth);
                        ++$c;
                    }
                    while (($c < ($column + $columnCount)) && ($c <= $maxCol)) {
                        $spreadsheet->getActiveSheet()->getColumnDimension(\Sincco\Excell\Cell::stringFromColumnIndex($c))->setWidth($columnWidth);
                        if ($hidden) {
                            $spreadsheet->getActiveSheet()->getColumnDimension(\Sincco\Excell\Cell::stringFromColumnIndex($c))->setVisible(false);
                        }
                        ++$c;
                    }
                }
        ...
        if (isset($gnmXML->Names)) {
            foreach ($gnmXML->Names->Name as $namedRange) {
                ...
                if ($worksheet = $spreadsheet->getSheetByName($range[0])) {
                    ...
                    $spreadsheet->addNamedRange(new \Sincco\Excell\NamedRange($name, $worksheet, $extractedRange));
                }
            }
        }
    ...
    private static function parseBorderAttributes($borderAttributes)
    {
        ...
        switch ($borderAttributes['Style']) {
            case '0':
                $styleArray['style'] = \Sincco\Excell\Style\Border::BORDER_NONE;
                break;
            case '1':
                $styleArray['style'] = \Sincco\Excell\Style\Border::BORDER_THIN;
                break;
            case '2':
                $styleArray['style'] = \Sincco\Excell\Style\Border::BORDER_MEDIUM;
                break;
            case '3':
                $styleArray['style'] = \Sincco\Excell\Style\Border::BORDER_SLANTDASHDOT;
                break;
            case '4':
                $styleArray['style'] = \Sincco\Excell\Style\Border::BORDER_DASHED;
                break;
            case '5':
                $styleArray['style'] = \Sincco\Excell\Style\Border::BORDER_THICK;
                break;
            case '6':
                $styleArray['style'] = \Sincco\Excell\Style\Border::BORDER_DOUBLE;
                break;
            case '7':
                $styleArray['style'] = \Sincco\Excell\Style\Border::BORDER_DOTTED;
                break;
            case '8':
                $styleArray['style'] = \Sincco\Excell\Style\Border::BORDER_MEDIUMDASHED;
                break;
            case '9':
                $styleArray['style'] = \Sincco\Excell\Style\Border::BORDER_DASHDOT;
                break;
            case '10':
                $styleArray['style'] = \Sincco\Excell\Style\Border::BORDER_MEDIUMDASHDOT;
                break;
            case '11':
                $styleArray['style'] = \Sincco\Excell\Style\Border::BORDER_DASHDOTDOT;
                break;
            case '12':
                $styleArray['style'] = \Sincco\Excell\Style\Border::BORDER_MEDIUMDASHDOTDOT;
                break;
            case '13':
                $styleArray['style'] = \Sincco\Excell\Style\Border::BORDER_MEDIUMDASHDOTDOT;
                break;
