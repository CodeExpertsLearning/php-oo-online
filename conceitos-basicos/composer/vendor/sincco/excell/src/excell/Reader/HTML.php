...
class HTML extends BaseReader implements IReader
{
    ...
    protected $formats = [
        ...
        'a' => [
            'font' => [
                'underline' => true,
                'color' => [
                    'argb' => \Sincco\Excell\Style\Color::COLOR_BLUE,
                ],
            ],
        ], //    Blue underlined
        'hr' => [
            'borders' => [
                'bottom' => [
                    'style' => \Sincco\Excell\Style\Border::BORDER_THIN,
                    'color' => [
                        \Sincco\Excell\Style\Color::COLOR_BLACK,
                    ],
                ],
            ],
        ], //    Bottom border
     ...
     */
    protected function processDomElement(DOMNode $element, \Sincco\Excell\Worksheet $sheet, &$row, &$column, &$cellContent)
    {
                ...
                switch ($child->nodeName) {
                    ...
                    case 'td':
                        ...
                        if (isset($attributeArray['rowspan']) && isset($attributeArray['colspan'])) {
                            ...
                            foreach (\Sincco\Excell\Cell::extractAllCellReferencesInRange($range) as $value) {
