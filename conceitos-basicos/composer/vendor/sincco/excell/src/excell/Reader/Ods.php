...
//        }
    ...
    public function load($pFilename)
    {
        ...
        $spreadsheet = new \Sincco\Excell\Spreadsheet();
    ...
    /**
     * Loads Excell from file into Excell instance
     *
     * @param     string         $pFilename
            ...
            foreach ($officePropertyMeta as $propertyName => $propertyValue) {
                ...
                switch ($propertyName) {
                    ...
                    case 'creation-date':
                        ...
                        break;
                    case 'user-defined':
                        $propertyValueType = \Sincco\Excell\Document\Properties::PROPERTY_TYPE_STRING;
                        foreach ($propertyValueAttributes as $key => $value) {
                            if ($key == 'name') {
                                ...
                                switch ($value) {
                                    case 'date':
                                        $propertyValue = \Sincco\Excell\Document\Properties::convertProperty($propertyValue, 'date');
                                        $propertyValueType = \Sincco\Excell\Document\Properties::PROPERTY_TYPE_DATE;
                                        break;
                                    case 'boolean':
                                        $propertyValue = \Sincco\Excell\Document\Properties::convertProperty($propertyValue, 'bool');
                                        $propertyValueType = \Sincco\Excell\Document\Properties::PROPERTY_TYPE_BOOLEAN;
                                        break;
                                    case 'float':
                                        $propertyValue = \Sincco\Excell\Document\Properties::convertProperty($propertyValue, 'r4');
                                        $propertyValueType = \Sincco\Excell\Document\Properties::PROPERTY_TYPE_FLOAT;
                                        break;
                                    default:
                                        $propertyValueType = \Sincco\Excell\Document\Properties::PROPERTY_TYPE_STRING;
                                }
...
//                                                                    ->setAuthor( $author )
                                ...
                                if (isset($cellDataText->p)) {
                                    ...
                                    switch ($cellDataOfficeAttributes['value-type']) {
                                        ...
                                        case 'percentage':
                                            ...
                                            $formatting = \Sincco\Excell\Style\NumberFormat::FORMAT_PERCENTAGE_00;
                                            break;
                                        case 'currency':
                                            $type = \Sincco\Excell\Cell\DataType::TYPE_NUMERIC;
                                            $dataValue = (float) $cellDataOfficeAttributes['value'];
                                            ...
                                            $formatting = \Sincco\Excell\Style\NumberFormat::FORMAT_CURRENCY_USD_SIMPLE;
                                            break;
                                        case 'float':
                                            $type = \Sincco\Excell\Cell\DataType::TYPE_NUMERIC;
                                            $dataValue = (float) $cellDataOfficeAttributes['value'];
                                        ...
                                        case 'date':
                                            ...
                                            $dataValue = \Sincco\Excell\Shared\Date::formattedPHPToExcel($year, $month, $day, $hour, $minute, $second);
                                            if ($dataValue != floor($dataValue)) {
                                                $formatting = \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_XLSX15 . ' ' . \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_TIME4;
                                            } else {
                                                $formatting = \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_XLSX15;
                                            }
                                            break;
                                        case 'time':
                                            $type = \Sincco\Excell\Cell\DataType::TYPE_NUMERIC;
                                            $dataValue = \Sincco\Excell\Shared\Date::PHPToExcel(strtotime('01-01-1970 ' . implode(':', sscanf($cellDataOfficeAttributes['time-value'], 'PT%dH%dM%dS'))));
                                            $formatting = \Sincco\Excell\Style\NumberFormat::FORMAT_DATE_TIME4;
                                            break;
                                    }
                                } else {
                                ...
                                if ($hasCalculatedValue) {
                                    ...
                                    foreach ($temp as &$value) {
                                        ...
                                        if ($tKey = !$tKey) {
                                            ...
                                            $value = \Sincco\Excell\Calculation::translateSeparator(';', ',', $value, $inBraces);
                                        }
                                    }
                                    unset($value);
                                ...
                                if ($type !== null) {
                                    for ($i = 0; $i < $colRepeats; ++$i) {
                                        ...
                                        if ($type !== \Sincco\Excell\Cell\DataType::TYPE_NULL) {
                                            for ($rowAdjust = 0; $rowAdjust < $rowRepeats; ++$rowAdjust) {
                                                ...
                                                if ($formatting !== null) {
                                                    ...
                                                    $spreadsheet->getActiveSheet()->getStyle($columnID . $rID)->getNumberFormat()->setFormatCode(\Sincco\Excell\Style\NumberFormat::FORMAT_GENERAL);
                                                }
                                                if ($hyperlink !== null) {
                                ...
                                if ((isset($cellDataTableAttributes['number-columns-spanned'])) || (isset($cellDataTableAttributes['number-rows-spanned']))) {
                                    if (($type !== \Sincco\Excell\Cell\DataType::TYPE_NULL) || (!$this->readDataOnly)) {
                                        $columnTo = $columnID;
                                        if (isset($cellDataTableAttributes['number-columns-spanned'])) {
                                            $columnTo = \Sincco\Excell\Cell::stringFromColumnIndex(\Sincco\Excell\Cell::columnIndexFromString($columnID) + $cellDataTableAttributes['number-columns-spanned'] - 2);
                                        }
                                        $rowTo = $rowID;
