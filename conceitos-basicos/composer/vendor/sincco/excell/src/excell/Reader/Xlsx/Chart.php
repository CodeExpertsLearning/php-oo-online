...
namespace Sincco\Excell\Reader\Xlsx;
...
class Chart
{
                        ...
                        switch ($chartDetailsKey) {
                            case 'plotArea':
                                ...
                                if ($plotAreaLayout == null) {
                                    $plotAreaLayout = new \Sincco\Excell\Chart\Layout();
                                }
                                $plotArea = new \Sincco\Excell\Chart\PlotArea($plotAreaLayout, $plotSeries);
                            ...
                            case 'legend':
                                ...
                                $legend = new \Sincco\Excell\Chart\Legend($legendPos, $legendLayout, $legendOverlay);
                                break;
                        }
                    }
            }
        }
        $chart = new \Sincco\Excell\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, $dispBlanksAs, $XaxisLabel, $YaxisLabel);
    ...
    private static function chartTitle($titleDetails, $namespacesChartMeta, $type)
    {
        ...
        return new \Sincco\Excell\Chart\Title($caption, $titleLayout);
    }
    ...
    private static function chartLayoutDetails($chartDetail, $namespacesChartMeta)
    {
        ...
        return new \Sincco\Excell\Chart\Layout($layout);
    }
    ...
    private static function chartDataSeries($chartDetail, $namespacesChartMeta, $plotType)
    {
        ...
        return new \Sincco\Excell\Chart\DataSeries($plotType, $multiSeriesType, $plotOrder, $seriesLabel, $seriesCategory, $seriesValues, $smoothLine);
    }
    ...
    private static function chartDataSeriesValueSet($seriesDetail, $namespacesChartMeta, $marker = null, $smoothLine = false)
    {
        if (isset($seriesDetail->strRef)) {
            ...
            return new \Sincco\Excell\Chart\DataSeriesValues('String', $seriesSource, $seriesData['formatCode'], $seriesData['pointCount'], $seriesData['dataValues'], $marker, $smoothLine);
        } elseif (isset($seriesDetail->numRef)) {
            $seriesSource = (string) $seriesDetail->numRef->f;
            $seriesData = self::chartDataSeriesValues($seriesDetail->numRef->numCache->children($namespacesChartMeta['c']));

            return new \Sincco\Excell\Chart\DataSeriesValues('Number', $seriesSource, $seriesData['formatCode'], $seriesData['pointCount'], $seriesData['dataValues'], $marker, $smoothLine);
        ...
        foreach ($titleDetailPart as $titleDetailElementKey => $titleDetailElement) {
            ...
            if (isset($titleDetailElement->rPr)) {
                ...
                if (!is_null($fontColor)) {
                    $objText->getFont()->setColor(new \Sincco\Excell\Style\Color(self::readColor($fontColor)));
                }
                ...
                if (!is_null($underscore)) {
                    if ($underscore == 'sng') {
                        ...
                        $objText->getFont()->setUnderline(\Sincco\Excell\Style\Font::UNDERLINE_DOUBLE);
                    } else {
                        $objText->getFont()->setUnderline(\Sincco\Excell\Style\Font::UNDERLINE_NONE);
                    }
                }
    ...
    /**
     * @param \Sincco\Excell\Chart\Layout $plotArea
     */
    private static function setChartAttributes(\Sincco\Excell\Chart\Layout $plotArea, $plotAttributes)
    {
