...
namespace Sincco\Excell\Helper;
...
class HTML
{
    ...
    public function toRichTextObject($html)
    {
        ...
        $this->richTextObject = new \Sincco\Excell\RichText();
    ...
    protected function buildTextRun()
    {
        ...
        if ($this->color) {
            $richtextRun->getFont()->setColor(new \Sincco\Excell\Style\Color('ff' . $this->color));
        }
        if ($this->bold) {
        ...
        if ($this->underline) {
            $richtextRun->getFont()->setUnderline(\Sincco\Excell\Style\Font::UNDERLINE_SINGLE);
        }
        if ($this->superscript) {
