...
class MathTrig
{
    ...
    public static function MDETERM($matrixValues)
    {
        ...
        try {
            $matrix = new \Sincco\Excell\Shared\JAMA\Matrix($matrixData);

            return $matrix->det();
        } catch (\Sincco\Excell\Exception $ex) {
            return Functions::VALUE();
        }
    }
    ...
    public static function MMULT($matrixData1, $matrixData2)
    {
        ...
        try {
            ...
            $matrixA = new \Sincco\Excell\Shared\JAMA\Matrix($matrixAData);
            $rowB = 0;
            ...
            $matrixB = new \Sincco\Excell\Shared\JAMA\Matrix($matrixBData);
