...
namespace Sincco\Excell\Calculation;
 ...
 *
 * @category    Excell
 * @copyright    Copyright (c) 2006 - 2016 Excell (https://github.com/Sincco/Excell)
...
class DateTime
{
    ...
    public static function getDateValue($dateValue)
    {
        if (!is_numeric($dateValue)) {
            ...
            if ((is_object($dateValue)) && ($dateValue instanceof \DateTime)) {
                $dateValue = \Sincco\Excell\Shared\Date::PHPToExcel($dateValue);
            } else {
    ...
    {
        // Execute function
        $PHPDateObject = \Sincco\Excell\Shared\Date::excelToDateTimeObject($dateValue);
     ...
     * and time format of your regional settings. Excell does not change cell formatting in this way.
     *
     * Excel Function:
     *        NOW()
     *
    ...
    public static function DATETIMENOW()
    {
        ...
        switch (Functions::getReturnDateType()) {
            case Functions::RETURNDATE_EXCEL:
                $retValue = (float) \Sincco\Excell\Shared\Date::PHPToExcel(time());
                break;
    ...
    public static function DATENOW()
    {
        ...
        date_default_timezone_set('UTC');
        $retValue = false;
        $excelDateTime = floor(\Sincco\Excell\Shared\Date::PHPToExcel(time()));
        switch (Functions::getReturnDateType()) {
            case Functions::RETURNDATE_EXCEL:
                $retValue = (float) $excelDateTime;
                break;
            case Functions::RETURNDATE_PHP_NUMERIC:
                $retValue = (integer) \Sincco\Excell\Shared\Date::excelToTimestamp($excelDateTime);
                break;
            case Functions::RETURNDATE_PHP_OBJECT:
                $retValue = \Sincco\Excell\Shared\Date::excelToDateTimeObject($excelDateTime);
                break;
        }
        date_default_timezone_set($saveTimeZone);
     ...
     *
     * NOTE: When used in a Cell Formula, MS Excel changes the cell format so that it matches the date
     * format of your regional settings. Excell does not change cell formatting in this way.
     *
     * Excel Function:
     *        DATE(year,month,day)
     *
     * Excell is a lot more forgiving than MS Excel when passing non numeric values to this function.
    ...
    public static function DATE($year = 0, $month = 1, $day = 1)
    {
        ...
        if (($month !== null) && (!is_numeric($month))) {
            $month = \Sincco\Excell\Shared\Date::monthStringToNumber($month);
        }

        if (($day !== null) && (!is_numeric($day))) {
            $day = \Sincco\Excell\Shared\Date::dayStringToNumber($day);
        }

        $year = ($year !== null) ? \Sincco\Excell\Shared\StringHelper::testStringAsNumeric($year) : 0;
        $month = ($month !== null) ? \Sincco\Excell\Shared\StringHelper::testStringAsNumeric($month) : 0;
        $day = ($day !== null) ? \Sincco\Excell\Shared\StringHelper::testStringAsNumeric($day) : 0;
        if ((!is_numeric($year)) ||
            (!is_numeric($month)) ||
            (!is_numeric($day))) {
            return Functions::VALUE();
        ...
        $baseYear = \Sincco\Excell\Shared\Date::getExcelCalendar();
        // Validate parameters
        ...
        // Execute function
        $excelDateValue = \Sincco\Excell\Shared\Date::formattedPHPToExcel($year, $month, $day);
        switch (Functions::getReturnDateType()) {
            case Functions::RETURNDATE_EXCEL:
                return (float) $excelDateValue;
            case Functions::RETURNDATE_PHP_NUMERIC:
                return (integer) \Sincco\Excell\Shared\Date::excelToTimestamp($excelDateValue);
            case Functions::RETURNDATE_PHP_OBJECT:
                return \Sincco\Excell\Shared\Date::excelToDateTimeObject($excelDateValue);
        }
    }
    ...
    public static function TIME($hour = 0, $minute = 0, $second = 0)
    {
        ...
        switch (Functions::getReturnDateType()) {
            case Functions::RETURNDATE_EXCEL:
                $date = 0;
                $calendar = \Sincco\Excell\Shared\Date::getExcelCalendar();
                if ($calendar != \Sincco\Excell\Shared\Date::CALENDAR_WINDOWS_1900) {
                    $date = 1;
                }

                return (float) \Sincco\Excell\Shared\Date::formattedPHPToExcel($calendar, 1, $date, $hour, $minute, $second);
            case Functions::RETURNDATE_PHP_NUMERIC:
                return (integer) \Sincco\Excell\Shared\Date::excelToTimestamp(\Sincco\Excell\Shared\Date::formattedPHPToExcel(1970, 1, 1, $hour, $minute, $second)); // -2147468400; //    -2147472000 + 3600
            case Functions::RETURNDATE_PHP_OBJECT:
                $dayAdjust = 0;
                if ($hour < 0) {
    ...
    public static function DATEVALUE($dateValue = 1)
    {
        ...
        if (($PHPDateArray !== false) && ($PHPDateArray['error_count'] == 0)) {
            ...
            $excelDateValue = floor(
                \Sincco\Excell\Shared\Date::formattedPHPToExcel(
                    $PHPDateArray['year'],
                    $PHPDateArray['month'],
                    $PHPDateArray['day'],
                    $PHPDateArray['hour'],
    ...
    public static function TIMEVALUE($timeValue)
    {
        ...
        if (($PHPDateArray !== false) && ($PHPDateArray['error_count'] == 0)) {
            if (Functions::getCompatibilityMode() == Functions::COMPATIBILITY_OPENOFFICE) {
                $excelDateValue = \Sincco\Excell\Shared\Date::formattedPHPToExcel(
                    $PHPDateArray['year'],
                    $PHPDateArray['month'],
                    $PHPDateArray['day'],
                    $PHPDateArray['hour'],
                ...
                $excelDateValue = \Sincco\Excell\Shared\Date::formattedPHPToExcel(1900, 1, 1, $PHPDateArray['hour'], $PHPDateArray['minute'], $PHPDateArray['second']) - 1;
            }
            ...
            switch (Functions::getReturnDateType()) {
                case Functions::RETURNDATE_EXCEL:
                    return (float) $excelDateValue;
                case Functions::RETURNDATE_PHP_NUMERIC:
                    return (integer) $phpDateValue = \Sincco\Excell\Shared\Date::excelToTimestamp($excelDateValue + 25569) - 3600;
                case Functions::RETURNDATE_PHP_OBJECT:
    ...
    public static function DATEDIF($startDate = 0, $endDate = 0, $unit = 'D')
    {
        ...
        $PHPStartDateObject = \Sincco\Excell\Shared\Date::excelToDateTimeObject($startDate);
        $startDays = $PHPStartDateObject->format('j');
        $startMonths = $PHPStartDateObject->format('n');
        $startYears = $PHPStartDateObject->format('Y');

        $PHPEndDateObject = \Sincco\Excell\Shared\Date::excelToDateTimeObject($endDate);
    ...
    public static function WORKDAY($startDate, $endDays)
    {
        ...
        switch (Functions::getReturnDateType()) {
            ...
            case Functions::RETURNDATE_PHP_NUMERIC:
                return (integer) \Sincco\Excell\Shared\Date::excelToTimestamp($endDate);
            case Functions::RETURNDATE_PHP_OBJECT:
                return \Sincco\Excell\Shared\Date::excelToDateTimeObject($endDate);
        }
    }
    ...
    public static function HOUROFDAY($timeValue = 0)
    {
        ...
        $timeValue = \Sincco\Excell\Shared\Date::excelToTimestamp($timeValue);
    ...
    public static function EDATE($dateValue = 1, $adjustmentMonths = 0)
    {
        ...
        switch (Functions::getReturnDateType()) {
            case Functions::RETURNDATE_EXCEL:
                return (float) \Sincco\Excell\Shared\Date::PHPToExcel($PHPDateObject);
            case Functions::RETURNDATE_PHP_NUMERIC:
                return (integer) \Sincco\Excell\Shared\Date::excelToTimestamp(\Sincco\Excell\Shared\Date::PHPToExcel($PHPDateObject));
            case Functions::RETURNDATE_PHP_OBJECT:
                return $PHPDateObject;
        }
    }
