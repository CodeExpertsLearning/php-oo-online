    ...
    public static function ifCondition($condition)
    {
        ...
        if (!in_array($condition{0}, ['>', '<', '='])) {
            if (!is_numeric($condition)) {
                $condition = \Sincco\Excell\Calculation::wrapResult(strtoupper($condition));
            }
            ...
            if (!is_numeric($operand)) {
                ...
                $operand = \Sincco\Excell\Calculation::wrapResult(strtoupper($operand));
            }
