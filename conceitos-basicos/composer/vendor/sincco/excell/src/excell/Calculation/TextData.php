...
class TextData
{
    ...
    public static function TRIMNONPRINTABLE($stringValue = '')
    {
        ...
        if (is_bool($stringValue)) {
            return ($stringValue) ? \Sincco\Excell\Calculation::getTRUE() : \Sincco\Excell\Calculation::getFALSE();
        }
    ...
    public static function ASCIICODE($characters)
    {
        ...
        if (is_bool($characters)) {
            if (Functions::getCompatibilityMode() == Functions::COMPATIBILITY_OPENOFFICE) {
                ...
                $characters = ($characters) ? \Sincco\Excell\Calculation::getTRUE() : \Sincco\Excell\Calculation::getFALSE();
            }
        }
        ...
        foreach ($aArgs as $arg) {
            if (is_bool($arg)) {
                if (Functions::getCompatibilityMode() == Functions::COMPATIBILITY_OPENOFFICE) {
                    ...
                    $arg = ($arg) ? \Sincco\Excell\Calculation::getTRUE() : \Sincco\Excell\Calculation::getFALSE();
                }
            }
            $returnValue .= $arg;
        }
    ...
    public static function DOLLAR($value = 0, $decimals = 2)
    {
        ...
        return \Sincco\Excell\Style\NumberFormat::toFormattedString($value, $mask);
    }
    ...
    public static function SEARCHSENSITIVE($needle, $haystack, $offset = 1)
    {
        ...
        if (!is_bool($needle)) {
            if (is_bool($haystack)) {
                $haystack = ($haystack) ? \Sincco\Excell\Calculation::getTRUE() : \Sincco\Excell\Calculation::getFALSE();
            }

            if (($offset > 0) && (\Sincco\Excell\Shared\StringHelper::countCharacters($haystack) > $offset)) {
                if (\Sincco\Excell\Shared\StringHelper::countCharacters($needle) == 0) {
                    return $offset;
                }
    ...
    public static function LEFT($value = '', $chars = 1)
    {
        ...
        if (is_bool($value)) {
            $value = ($value) ? \Sincco\Excell\Calculation::getTRUE() : \Sincco\Excell\Calculation::getFALSE();
        }
    ...
    public static function LOWERCASE($mixedCaseString)
    {
        ...
        if (is_bool($mixedCaseString)) {
            $mixedCaseString = ($mixedCaseString) ? \Sincco\Excell\Calculation::getTRUE() : \Sincco\Excell\Calculation::getFALSE();
        }

        return \Sincco\Excell\Shared\StringHelper::strToLower($mixedCaseString);
    }
    ...
    public static function UPPERCASE($mixedCaseString)
    {
        ...
        return \Sincco\Excell\Shared\StringHelper::strToUpper($mixedCaseString);
    }
    ...
    public static function PROPERCASE($mixedCaseString)
    {
        ...
        return \Sincco\Excell\Shared\StringHelper::strToTitle($mixedCaseString);
    }
    ...
    public static function TEXTFORMAT($value, $format)
    {
        ...
        if ((is_string($value)) && (!is_numeric($value)) && \Sincco\Excell\Shared\Date::isDateTimeFormatCode($format)) {
            $value = DateTime::DATEVALUE($value);
        }

        return (string) \Sincco\Excell\Style\NumberFormat::toFormattedString($value, $format);
    }
    ...
    public static function VALUE($value = '')
    {
        ...
        if (!is_numeric($value)) {
            $numberValue = str_replace(
                \Sincco\Excell\Shared\StringHelper::getThousandsSeparator(),
                '',
                trim($value, " \t\n\r\0\x0B" . \Sincco\Excell\Shared\StringHelper::getCurrencyCode())
            );
