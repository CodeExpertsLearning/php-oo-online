...
class Financial
{
    ...
    private static function couponFirstPeriodDate($settlement, $maturity, $frequency, $next)
    {
        ...
        $result = \Sincco\Excell\Shared\Date::excelToDateTimeObject($maturity);
        $eom = self::isLastDayOfMonth($result);

        while ($settlement < \Sincco\Excell\Shared\Date::PHPToExcel($result)) {
        ...
        return \Sincco\Excell\Shared\Date::PHPToExcel($result);
    }
