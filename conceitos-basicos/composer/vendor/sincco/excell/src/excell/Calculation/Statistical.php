 ...
 */
    ...
    public static function AVERAGEIF($aArgs, $condition, $averageArgs = [])
    {
        ...
        foreach ($aArgs as $key => $arg) {
            if (!is_numeric($arg)) {
                $arg = \Sincco\Excell\Calculation::wrapResult(strtoupper($arg));
            }
            $testCondition = '=' . $arg . $condition;
            if (\Sincco\Excell\Calculation::getInstance()->_calculateFormulaValue($testCondition)) {
    ...
    public static function CORREL($yValues, $xValues = null)
    {
        ...
        $bestFitLinear = \Sincco\Excell\Shared\trend\trend::calculate(\Sincco\Excell\Shared\trend\trend::TREND_LINEAR, $yValues, $xValues);
    ...
    public static function GROWTH($yValues, $xValues = [], $newValues = [], $const = true)
    {
        ...
        $bestFitExponential = \Sincco\Excell\Shared\trend\trend::calculate(\Sincco\Excell\Shared\trend\trend::TREND_EXPONENTIAL, $yValues, $xValues, $const);
        if (empty($newValues)) {
    ...
    public static function LINEST($yValues, $xValues = null, $const = true, $stats = false)
    {
        ...
        $bestFitLinear = \Sincco\Excell\Shared\trend\trend::calculate(\Sincco\Excell\Shared\trend\trend::TREND_LINEAR, $yValues, $xValues, $const);
        if ($stats) {
            return [
                [
