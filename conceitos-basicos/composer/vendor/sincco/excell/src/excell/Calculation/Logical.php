...
class Logical
{
    ...
    public static function logicalAnd()
    {
        ...
        foreach ($aArgs as $argCount => $arg) {
            ...
            if (is_bool($arg)) {
                ...
                $arg = strtoupper($arg);
                if (($arg == 'TRUE') || ($arg == \Sincco\Excell\Calculation::getTRUE())) {
                    $arg = true;
                } elseif (($arg == 'FALSE') || ($arg == \Sincco\Excell\Calculation::getFALSE())) {
                    $arg = false;
                } else {
    ...
    public static function NOT($logical = false)
    {
        ...
        if (is_string($logical)) {
            ...
            if (($logical == 'TRUE') || ($logical == \Sincco\Excell\Calculation::getTRUE())) {
                return false;
            } elseif (($logical == 'FALSE') || ($logical == \Sincco\Excell\Calculation::getFALSE())) {
                return true;
            } else {
                return Functions::VALUE();
            }
