...
class Worksheet implements IComparable
{
    ...
    /**
     * Set default style - should only be used by \Sincco\Excell\IReader implementations!
     *
     * @deprecated
     * @param Style $pValue
     * @throws Exception
     ...
     * @param int $pColumn Numeric column coordinate of the cell
     * @param int $pRow Numeric row coordinate of the cell
     * @param  int $pBreak Break type (type of \Sincco\Excell\Worksheet::BREAK_*)
     * @return Worksheet
     */
