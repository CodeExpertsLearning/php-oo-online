...
class DocProps extends WriterPart
{
     ...
     */
    public function writeDocPropsApp(\Sincco\Excell\SpreadSheet $spreadsheet = null)
    {
        // Create XML writer
        $objWriter = null;
     ...
     * @return string  XML Output
     */
    public function writeDocPropsCore(\Sincco\Excell\SpreadSheet $spreadsheet = null)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
     ...
     * @return string  XML Output
     */
    public function writeDocPropsCustom(\Sincco\Excell\SpreadSheet $spreadsheet = null)
    {
