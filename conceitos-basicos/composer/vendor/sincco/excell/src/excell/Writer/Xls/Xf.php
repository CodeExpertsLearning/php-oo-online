...
class Xf
{
     ...
     * Constructor
     *
     * @param \Sincco\Excell\Style    The XF format
     */
    public function __construct(\Sincco\Excell\Style $style = null)
    {
    ...
    public function writeXf()
    {
        ...
        $diag_tl_to_rb = $diagonalDirection == \Sincco\Excell\Style\Borders::DIAGONAL_BOTH
                            || $diagonalDirection == \Sincco\Excell\Style\Borders::DIAGONAL_DOWN;
        $diag_tr_to_lb = $diagonalDirection == \Sincco\Excell\Style\Borders::DIAGONAL_BOTH
                            || $diagonalDirection == \Sincco\Excell\Style\Borders::DIAGONAL_UP;
    ...
    private static $mapBorderStyles = [
        \Sincco\Excell\Style\Border::BORDER_NONE => 0x00,
        \Sincco\Excell\Style\Border::BORDER_THIN => 0x01,
        \Sincco\Excell\Style\Border::BORDER_MEDIUM => 0x02,
        \Sincco\Excell\Style\Border::BORDER_DASHED => 0x03,
        \Sincco\Excell\Style\Border::BORDER_DOTTED => 0x04,
        \Sincco\Excell\Style\Border::BORDER_THICK => 0x05,
        \Sincco\Excell\Style\Border::BORDER_DOUBLE => 0x06,
        \Sincco\Excell\Style\Border::BORDER_HAIR => 0x07,
        \Sincco\Excell\Style\Border::BORDER_MEDIUMDASHED => 0x08,
        \Sincco\Excell\Style\Border::BORDER_DASHDOT => 0x09,
        \Sincco\Excell\Style\Border::BORDER_MEDIUMDASHDOT => 0x0A,
        \Sincco\Excell\Style\Border::BORDER_DASHDOTDOT => 0x0B,
        \Sincco\Excell\Style\Border::BORDER_MEDIUMDASHDOTDOT => 0x0C,
        \Sincco\Excell\Style\Border::BORDER_SLANTDASHDOT => 0x0D,
    ];
    ...
    private static $mapFillTypes = [
        \Sincco\Excell\Style\Fill::FILL_NONE => 0x00,
        \Sincco\Excell\Style\Fill::FILL_SOLID => 0x01,
        \Sincco\Excell\Style\Fill::FILL_PATTERN_MEDIUMGRAY => 0x02,
        \Sincco\Excell\Style\Fill::FILL_PATTERN_DARKGRAY => 0x03,
        \Sincco\Excell\Style\Fill::FILL_PATTERN_LIGHTGRAY => 0x04,
        \Sincco\Excell\Style\Fill::FILL_PATTERN_DARKHORIZONTAL => 0x05,
        \Sincco\Excell\Style\Fill::FILL_PATTERN_DARKVERTICAL => 0x06,
        \Sincco\Excell\Style\Fill::FILL_PATTERN_DARKDOWN => 0x07,
        \Sincco\Excell\Style\Fill::FILL_PATTERN_DARKUP => 0x08,
        \Sincco\Excell\Style\Fill::FILL_PATTERN_DARKGRID => 0x09,
        \Sincco\Excell\Style\Fill::FILL_PATTERN_DARKTRELLIS => 0x0A,
        \Sincco\Excell\Style\Fill::FILL_PATTERN_LIGHTHORIZONTAL => 0x0B,
        \Sincco\Excell\Style\Fill::FILL_PATTERN_LIGHTVERTICAL => 0x0C,
        \Sincco\Excell\Style\Fill::FILL_PATTERN_LIGHTDOWN => 0x0D,
        \Sincco\Excell\Style\Fill::FILL_PATTERN_LIGHTUP => 0x0E,
        \Sincco\Excell\Style\Fill::FILL_PATTERN_LIGHTGRID => 0x0F,
        \Sincco\Excell\Style\Fill::FILL_PATTERN_LIGHTTRELLIS => 0x10,
        \Sincco\Excell\Style\Fill::FILL_PATTERN_GRAY125 => 0x11,
        \Sincco\Excell\Style\Fill::FILL_PATTERN_GRAY0625 => 0x12,
        \Sincco\Excell\Style\Fill::FILL_GRADIENT_LINEAR => 0x00, // does not exist in BIFF8
        \Sincco\Excell\Style\Fill::FILL_GRADIENT_PATH => 0x00, // does not exist in BIFF8
    ];
    ...
    private static $mapHAlignments = [
        \Sincco\Excell\Style\Alignment::HORIZONTAL_GENERAL => 0,
        \Sincco\Excell\Style\Alignment::HORIZONTAL_LEFT => 1,
        \Sincco\Excell\Style\Alignment::HORIZONTAL_CENTER => 2,
        \Sincco\Excell\Style\Alignment::HORIZONTAL_RIGHT => 3,
        \Sincco\Excell\Style\Alignment::HORIZONTAL_FILL => 4,
        \Sincco\Excell\Style\Alignment::HORIZONTAL_JUSTIFY => 5,
        \Sincco\Excell\Style\Alignment::HORIZONTAL_CENTER_CONTINUOUS => 6,
    ];
    ...
    private static $mapVAlignments = [
        \Sincco\Excell\Style\Alignment::VERTICAL_TOP => 0,
        \Sincco\Excell\Style\Alignment::VERTICAL_CENTER => 1,
        \Sincco\Excell\Style\Alignment::VERTICAL_BOTTOM => 2,
        \Sincco\Excell\Style\Alignment::VERTICAL_JUSTIFY => 3,
    ];
    ...
    {
        switch ($locked) {
            case \Sincco\Excell\Style\Protection::PROTECTION_INHERIT:
                return 1;
            case \Sincco\Excell\Style\Protection::PROTECTION_PROTECTED:
                return 1;
            case \Sincco\Excell\Style\Protection::PROTECTION_UNPROTECTED:
                return 0;
            default:
                return 1;
        }
