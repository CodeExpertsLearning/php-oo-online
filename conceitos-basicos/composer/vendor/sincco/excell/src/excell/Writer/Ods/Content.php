...
namespace Sincco\Excell\Writer\Ods;
...
class Content extends WriterPart
{
     ...
     */
    public function write(\Sincco\Excell\SpreadSheet $spreadsheet = null)
    {
        if (!$spreadsheet) {
            $spreadsheet = $this->getParentWriter()->getSpreadsheet(); /* @var $spreadsheet Excell */
        }
     ...
     * Write sheets
     *
     * @param \Sincco\Excell\Shared\XMLWriter $objWriter
     */
    private function writeSheets(\Sincco\Excell\Shared\XMLWriter $objWriter)
    {
        $spreadsheet = $this->getParentWriter()->getSpreadsheet(); /* @var $spreadsheet Excell */
     ...
     */
    private function writeRows(\Sincco\Excell\Shared\XMLWriter $objWriter, \Sincco\Excell\Worksheet $sheet)
    {
     ...
     *
     * @param \Sincco\Excell\Shared\XMLWriter $objWriter
     * @param \Sincco\Excell\Worksheet\Row $row
     * @throws \Sincco\Excell\Writer\Exception
     */
    private function writeCells(\Sincco\Excell\Shared\XMLWriter $objWriter, \Sincco\Excell\Worksheet\Row $row)
    {
        ...
        while ($cells->valid()) {
            ...
            switch ($cell->getDataType()) {
                ...
                case \Sincco\Excell\Cell\DataType::TYPE_ERROR:
                    throw new \Sincco\Excell\Writer\Exception('Writing of error not implemented yet.');
                    break;
                ...
                case \Sincco\Excell\Cell\DataType::TYPE_INLINE:
                    throw new \Sincco\Excell\Writer\Exception('Writing of inline not implemented yet.');
                    break;
     ...
     */
    private function writeCellSpan(\Sincco\Excell\Shared\XMLWriter $objWriter, $curColumn, $prevColumn)
    {
