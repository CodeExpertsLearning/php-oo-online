...
class Escher
{
    ...
    public function close()
    {
        ...
        switch (get_class($this->object)) {
            case '\\Sincco\\Excell\\Shared\\Escher':
                ...
                break;
            case '\\Sincco\\Excell\\Shared\\Escher\\DggContainer':
                ...
                break;
            case '\\Sincco\\Excell\\Shared\\Escher\\DggContainer\\BstoreContainer':
                // this is a container record
                ...
                $this->data = $header . $innerData;
                break;
            case '\\Sincco\\Excell\\Shared\\Escher\\DggContainer\\BstoreContainer\\BSE':
                ...
                $this->data .= $data;
                break;
            case '\\Sincco\\Excell\\Shared\\Escher\\DggContainer\\BstoreContainer\\BSE\\Blip':
                ...
                break;
            case '\\Sincco\\Excell\\Shared\\Escher\\DgContainer':
                // this is a container record
                ...
                $this->data = $header . $innerData;
                break;
            case '\\Sincco\\Excell\\Shared\\Escher\\DgContainer\\SpgrContainer':
                // this is a container record
                ...
                $this->spTypes = $spTypes;
                break;
            case '\\Sincco\\Excell\\Shared\\Escher\\DgContainer\\SpgrContainer\\SpContainer':
                // initialize
                $data = '';
                ...
                if ($this->object->getStartCoordinates()) {
                    ...
                    // start coordinates
                    list($column, $row) = \Sincco\Excell\Cell::coordinateFromString($this->object->getStartCoordinates());
                    $c1 = \Sincco\Excell\Cell::columnIndexFromString($column) - 1;
                    $r1 = $row - 1;
                    ...
                    // end coordinates
                    list($column, $row) = \Sincco\Excell\Cell::coordinateFromString($this->object->getEndCoordinates());
                    $c2 = \Sincco\Excell\Cell::columnIndexFromString($column) - 1;
                    $r2 = $row - 1;
