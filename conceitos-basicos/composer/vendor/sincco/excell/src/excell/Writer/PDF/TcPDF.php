...
$pdfRendererClassFile = \Sincco\Excell\Settings::getPdfRendererPath() . '/tcpdf.php';
if (file_exists($pdfRendererClassFile)) {
    $k_path_url = \Sincco\Excell\Settings::getPdfRendererPath();
 ...
 */
class TcPDF extends Core implements \Sincco\Excell\Writer\IWriter
{
    /**
    ...
    public function save($pFilename = null)
    {
        ...
        if (!is_null($this->getOrientation())) {
            $orientation = ($this->getOrientation() == \Sincco\Excell\Worksheet\PageSetup::ORIENTATION_LANDSCAPE)
                ? 'L'
                : 'P';
        }
        //  Override Paper Size
