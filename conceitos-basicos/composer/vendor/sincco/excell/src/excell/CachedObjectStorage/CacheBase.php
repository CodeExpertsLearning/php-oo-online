...
abstract class CacheBase
{
     ...
     */
    public function __construct(\Sincco\Excell\Worksheet $parent)
    {
        //    Set our parent worksheet.
        //    This is maintained within the cache controller to facilitate re-attaching it to \Sincco\Excell\Cell objects when
    ...
    public function getHighestColumn($row = null)
    {
        ...
        foreach ($this->getCellList() as $coord) {
            ...
            $columnList[] = \Sincco\Excell\Cell::columnIndexFromString($c);
        }

        return \Sincco\Excell\Cell::stringFromColumnIndex(max($columnList) - 1);
    }
