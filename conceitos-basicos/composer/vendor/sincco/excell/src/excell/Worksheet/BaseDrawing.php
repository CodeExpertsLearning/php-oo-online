 ...
 */
class BaseDrawing implements \Sincco\Excell\IComparable
{
    /**
     * Image counter
     *
     ...
     * Set Worksheet
     *
     * @param     \Sincco\Excell\Worksheet     $pValue
     * @param     bool                 $pOverrideOld    If a Worksheet has already been assigned, overwrite it and remove image from old Worksheet?
     * @throws    \Sincco\Excell\Exception
     * @return    BaseDrawing
     */
    public function setWorksheet(\Sincco\Excell\Worksheet $pValue = null, $pOverrideOld = false)
    {
        if (is_null($this->worksheet)) {
            // Add drawing to \Sincco\Excell\Worksheet
            $this->worksheet = $pValue;
            $this->worksheet->getCell($this->coordinates);
            $this->worksheet->getDrawingCollection()->append($this);
        } else {
            if ($pOverrideOld) {
                // Remove drawing from old \Sincco\Excell\Worksheet
                ...
                // Set new \Sincco\Excell\Worksheet
                $this->setWorksheet($pValue);
            } else {
                throw new \Sincco\Excell\Exception("A \Sincco\Excell\Worksheet has already been assigned. Drawings can only exist on one \Sincco\Excell\Worksheet.");
            }
        }
