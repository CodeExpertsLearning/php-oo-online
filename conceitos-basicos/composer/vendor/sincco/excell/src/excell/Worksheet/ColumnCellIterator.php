...
class ColumnCellIterator extends CellIterator implements \Iterator
{
     ...
     */
    public function __construct(\Sincco\Excell\Worksheet $subject = null, $columnIndex = 'A', $startRow = 1, $endRow = null)
    {
        // Set subject
        $this->subject = $subject;
        $this->columnIndex = \Sincco\Excell\Cell::columnIndexFromString($columnIndex) - 1;
    ...
    public function seek($row = 1)
    {
        if (($row < $this->startRow) || ($row > $this->endRow)) {
            throw new \Sincco\Excell\Exception("Row $row is out of range ({$this->startRow} - {$this->endRow})");
     ...
     *
     * @return null|\Sincco\Excell\Cell
     */
    ...
    public function prev()
    {
        if ($this->position <= $this->startRow) {
            throw new \Sincco\Excell\Exception("Row is already at the beginning of range ({$this->startRow} - {$this->endRow})");
        }
