...
namespace Sincco\Excell\Worksheet\AutoFilter;
...
class Column
{
     ...
     * Autofilter
     *
     * @var \Sincco\Excell\Worksheet\AutoFilter
     */
    private $parent;
     ...
     *    @param    \Sincco\Excell\Worksheet\AutoFilter  $pParent        Autofilter for this column
     */
    public function __construct($pColumn, \Sincco\Excell\Worksheet\AutoFilter $pParent = null)
    {
     ...
     *
     * @return \Sincco\Excell\Worksheet\AutoFilter
     */
     ...
     *
     * @param \Sincco\Excell\Worksheet\AutoFilter
     * @return Column
     */
    public function setParent(\Sincco\Excell\Worksheet\AutoFilter $pParent = null)
    {
        $this->parent = $pParent;
    ...
    public function setFilterType($pFilterType = self::AUTOFILTER_FILTERTYPE_FILTER)
    {
        if (!in_array($pFilterType, self::$filterTypes)) {
            throw new \Sincco\Excell\Exception('Invalid filter type for column AutoFilter.');
        }
    ...
    public function setJoin($pJoin = self::AUTOFILTER_COLUMN_JOIN_OR)
    {
        ...
        if (!in_array($pJoin, self::$ruleJoins)) {
            throw new \Sincco\Excell\Exception('Invalid rule connection for column AutoFilter.');
        }
